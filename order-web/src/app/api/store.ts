...
import orderHistoryData from "@/temp_data/orderHistoryData.json"
import axios from "axios";
import { ReceiptData, RootOrderData } from "@/types/store";
...
// 영수증 데이터
export async function getOrderHistory():Promise<RootOrderData> {
  try {
    // const response = await axios.get(`해당주소/${receiptId}`, {
    //   headers: {
    //     "Content-Type": "application/json",
